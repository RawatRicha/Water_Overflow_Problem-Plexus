...
You will need Python 3.6 or higher to run the command directly. **No other dependencies should be required**.

1. Clone this repo.

   ```bash
   git clone https://github.com/RawatRicha/Water-Overflow-Problem--Plexus.git
   ```
...
3. Run the Python script.
   ...
   ```bash
   python calculate_water_overflow.py -i 3 -j 1 -k 3
   ```
...
```bash
python calculate_water_overflow.py -i 3 -j 1 -k 3 -v
```
...
```bash
# From root directory.
python -m unittest tests.test_overflow  
```
